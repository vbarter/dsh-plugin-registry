...
(function (global) {
  ...
  const DICT = {
    zh: {
      ...
      "index.heroSub": "DeepSeek Harness 插件是挂进 dsh profile 的社区能力包。本站是目录：先看来源和 Manifest 状态，再决定装不装。不是官方站。怎么装走",
      "index.heroSub.link": "安装说明",
      "index.heroSub.after": "，别在这页找命令。",
      "index.catalogNote": "这里是社区目录，不是官方 marketplace 或插件商店；先查看来源与 Manifest 状态，再前往 ",
      "index.catalogNote.link": "/install",
      "index.catalogNote.after": " 了解官方 CLI 安装方式。",
      "index.limitsNote": "本站只做社区浏览与 Manifest 形态核对：`格式检查通过` ≠ 已安装测试，更不是安全审计。条目来自公开 GitHub，依赖、权限与数据外发需你自己读 README 与源码后再决定。官方发现路径仍是 GitHub ",
      "index.limitsNote.topic": "dsh-plugin topic",
      "index.limitsNote.mid": "；官方产品说明见 ",
      "index.limitsNote.harness": "DeepSeek Harness",
      "index.limitsNote.after": "。",
      ...
      "faq.title": "常见问题",
      "faq.q1": "什么是 DeepSeek Harness 插件？",
      "faq.a1": "给 Harness 加路由、检索、界面等能力的社区包，官方发现仍是 GitHub `dsh-plugin` topic。",
      "faq.q2": "Manifest 在哪看？",
      "faq.a2": "本站每条卡片上的来源 / Manifest 状态。有有效 `dsh.bundle` 才给安装入口；未检查 ≠ 已测过。",
      "faq.q3": "这是什么注册表？",
      "faq.a3": "dsplugin.app 是 DeepSeek Harness（dsh）社区插件目录，收录公开 GitHub 仓库，供浏览、筛选和复制安装命令。本站由社区维护，不是 DeepSeek 官方站点。",
      "faq.q4": "dsh.bundle 是什么？",
      "faq.a4": "dsh.bundle 是插件仓库根目录 package.json 里的声明，指向一份相对路径的 patch 文件。格式核对通过后，安装步骤见 /install，本页不写 add 命令。",
      "faq.a4.before": "dsh.bundle 是插件仓库根目录 package.json 里的声明，指向一份相对路径的 patch 文件。格式核对通过后，安装步骤见 ",
      "faq.a4.after": "，本页不写 add 命令。",
      "faq.q5": "如何发布插件？",
      "faq.a5": "在发布页预检公开 GitHub 仓库，再通过 Issue / PR 提交到 vbarter/dsh-plugin-registry。维护者合并后，dsplugin.app 上的目录才会更新。",
      "faq.q6": "「未检查」和「格式检查」是什么意思？",
      "faq.a6": "「格式检查通过」表示本站核对过 package.json 里的 dsh.bundle 形态。「未检查」表示条目来自社区目录，本站尚未核对其 Manifest。两者都不是安全审计，也不等于已经做过安装测试。",
      "faq.q7": "和 GitHub topic 的区别",
      "faq.a7": "官方发现仍是 GitHub dsh-plugin topic。本站是社区目录，有有效 dsh.bundle 才给安装命令。",
      "faq.q8": "什么是 dsh 插件市场？",
      ...
      "index.faq.a10.after": "。",
      "index.faq.q11": "目录里的 Manifest 状态能当安全背书吗？",
      "index.faq.a11": "不能。Manifest 只说明 `dsh.bundle` 形态是否对过；不保证可用、无后门、或与你的 profile 兼容。来源风险自负，安装说明见 /install。",
      "index.faq.a11.before": "不能。Manifest 只说明 `dsh.bundle` 形态是否对过；不保证可用、无后门、或与你的 profile 兼容。来源风险自负，安装说明见 ",
      "index.faq.a11.after": "。",
      "publish.faq.q1": "dsh.bundle 怎么写？",
      "publish.faq.a1": "package.json 里 dsh.bundle.patch 相对路径；加 topic dsh-plugin；本页预检 → Issue → registry。",
      "publish.faq.q2": "预检失败了怎么办？",
      "publish.faq.a2": "按 Issue/检查输出改契约（公开仓库、合法相对路径 patch、topic），不要另开账号体系；修完回同一提交线程。通过也不等于官方背书或安全审计。",
      "publish.precheckNote": "预检不过常见：仓库非公开、package.json 缺 `dsh.bundle.patch`、路径含 `..`、未加 `dsh-plugin` topic。修完在同一 Issue 跟进；本站非官方，合并进 ",
      "publish.precheckNote.registry": "vbarter/dsh-plugin-registry",
      "publish.precheckNote.mid": " 后目录才更新。官方如何声明 bundle 见：",
      "publish.precheckNote.docs": "Package and install a plugin",
      "publish.precheckNote.after": "。",
    ...
    en: {
      ...
      "index.heroSub": "DeepSeek Harness plugins are community capability packs you attach to a dsh profile. This site is a catalog: check source and Manifest status first, then decide whether to install. Not an official site. How to install: ",
      "index.heroSub.link": "install guide",
      "index.heroSub.after": " — do not look for commands on this page.",
      "index.catalogNote": "This is a community catalog, not an official marketplace or plugin store; check source and Manifest status first, then go to ",
      "index.catalogNote.link": "/install",
      "index.catalogNote.after": " for the official CLI install flow.",
      "index.limitsNote": "This site only does community browsing and Manifest shape checks: `Shape validated` ≠ installed/tested, and it is not a security audit. Entries come from public GitHub; read the README and source yourself for dependencies, permissions, and outbound data. Official discovery is still the GitHub ",
      "index.limitsNote.topic": "dsh-plugin topic",
      "index.limitsNote.mid": "; official product docs: ",
      "index.limitsNote.harness": "DeepSeek Harness",
      "index.limitsNote.after": ".",
      ...
      "faq.title": "FAQ",
      "faq.q1": "What is a DeepSeek Harness plugin?",
      "faq.a1": "A community pack that adds routing, retrieval, UI, etc. to Harness. Official discovery is still the GitHub `dsh-plugin` topic.",
      "faq.q2": "Where do I see Manifest status?",
      "faq.a2": "On each catalog card: source / Manifest status. A valid `dsh.bundle` is required before an install entry appears; Unchecked ≠ tested.",
      "faq.q3": "What is this registry?",
      "faq.a3": "dsplugin.app is a community catalog of DeepSeek Harness (dsh) plugins: public GitHub repositories you can browse, filter, and install from. It is community-run, not an official DeepSeek site.",
      "faq.q4": "What is dsh.bundle?",
      "faq.a4": "dsh.bundle is a root package.json declaration that points at a patch file (a safe relative path). After format check passes, see /install for install steps; this page does not print add commands.",
      "faq.a4.before": "dsh.bundle is a root package.json declaration that points at a patch file (a safe relative path). After format check passes, see ",
      "faq.a4.after": " for install steps; this page does not print add commands.",
      "faq.q5": "How do I publish a plugin?",
      "faq.a5": "Precheck a public GitHub repository on the publish page, then file an Issue/PR on vbarter/dsh-plugin-registry. The dsplugin.app catalog updates after a maintainer merges.",
      "faq.q6": "What do “not checked” and “shape validated” mean?",
      "faq.a6": "Shape validated means this site checked the dsh.bundle shape in package.json. Not checked (未检查) means the row came from the community catalog and was not re-checked here. Neither label is a security audit or an install test.",
      "faq.q7": "How is this different from the GitHub topic?",
      "faq.a7": "Official discovery is still the GitHub dsh-plugin topic. This site is a community catalog and only shows an install command when a valid dsh.bundle is present.",
      "faq.q8": "What is the dsh plugin marketplace?",
      ...
      "index.faq.a10.after": ".",
      "index.faq.q11": "Can Manifest status in the catalog be treated as a security endorsement?",
      "index.faq.a11": "No. Manifest only says whether the `dsh.bundle` shape checked out; it does not guarantee it works, has no backdoors, or matches your profile. Source risk is yours. Install notes are on /install.",
      "index.faq.a11.before": "No. Manifest only says whether the `dsh.bundle` shape checked out; it does not guarantee it works, has no backdoors, or matches your profile. Source risk is yours. Install notes are on ",
      "index.faq.a11.after": ".",
      ...
      "publish.faq.q2": "What if precheck fails?",
      "publish.faq.a2": "Fix the contract from the Issue/check output (public repo, safe relative-path patch, topic). Do not open a separate account system; follow up on the same submission thread. Passing is not an official endorsement or a security audit.",
      "publish.precheckNote": "Precheck often fails when the repo is not public, package.json lacks `dsh.bundle.patch`, the path contains `..`, or the `dsh-plugin` topic is missing. Follow up on the same Issue after you fix it. This site is unofficial; the catalog updates only after a merge into ",
      "publish.precheckNote.registry": "vbarter/dsh-plugin-registry",
      "publish.precheckNote.mid": ". Official bundle declaration: ",
      "publish.precheckNote.docs": "Package and install a plugin",
      "publish.precheckNote.after": ".",
